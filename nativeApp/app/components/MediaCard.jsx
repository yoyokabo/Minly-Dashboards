    ...
    <View className="flex flex-col items-center px-4 mb-8 border-4 border-blackrounded rounded-3xl justify bg-black-200">
      <View className="flex flex-row gap-5 items-start">
        <View className="flex justify-center items-center flex-row flex-1">
          <View className=" rounded-lg  flex justify-center items-center p-0.5 gap-1">
          </View>
      ...
      {image &&<Image source={{ uri: image}}
       style={{width: 400, height: 500}} />}
        ...
        />}
          ...
          <View className="flex justify-center flex-1 ml-3 gap-y-1">
            <Text
              className="font-pregular text-lg text-white"
            >
              {caption}
            </Text>
      ...
      <Text
              className="font-pregular text-lg text-white flex-row"
            >
              Likes : {likesUpdated}
            </Text>
          </View>
